...
public class Edit : PropertyEditor<LongProperty,long>
{
    ...
    public Edit(PhoneDbContext context)
    {
        ...
        _validateRequest = PropertyUtils.CreatePropertyEditRequestValidator(
            this,
            propertyId => _context.LongProperties
                .Include(item => item.LongPropertyType)
